...
export default function ThreadList() {
  ...
  if (!data || !data.threads || data.threads.length === 0) return <p className="muted">No threads found.</p>;
  ...
  return (
    <>
      ...
      <div className="pagination" style={{ display: "flex", gap: "1rem", alignItems: "center", marginTop: "1rem" }}>
        <button
